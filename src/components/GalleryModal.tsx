      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="relative max-h-[90vh] w-full max-w-5xl overflow-y-auto rounded-2xl border border-neutral-200 bg-white p-6 shadow-2xl dark:border-neutral-800 dark:bg-neutral-900"
          >
            {/* 헤더 */}
            <div className="flex items-center justify-between border-b border-neutral-200 pb-4 dark:border-neutral-800">
              <div>
                ...
                <p className="mt-1 text-xs text-neutral-500 dark:text-neutral-400">
                  세 가지 화면비(1:1, 4:5, 9:16)로 완성된 카드 예시입니다. 클릭하여 바로 편집기에 불러오거나 다운로드할
                  수 있습니다.
                </p>
              </div>
                ...
                >
                  <div>
                    ...
                    <div className="bg-canvas-pattern relative flex aspect-square items-center justify-center overflow-hidden p-3">
                      ...
                      />
                      <span className="absolute top-3 left-3 rounded-lg bg-neutral-950/80 px-2 py-0.5 text-[10px] font-bold text-white shadow-xs">
                        {work.aspectRatio}
                      </span>
                    </div>
